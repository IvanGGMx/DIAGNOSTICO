...
"options":["Hay un punto de equivalencia",
"Pueden existir múltiples puntos",
"No ocurre reacción",
"Siempre precipita"],
    ...
    if st.session_state.current_question < total:
        ...
        try:
            ...
            for i in range(len(questions)):
                fila.append(st.session_state.answers.get(i,""))
        ...
        st.success(f"Resultado: {correct}/{len(questions)}")
